...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupQuestions() {
        questions.add(
            Question(
                1, QuestionType.Text, "What is the capital of Nagaland?",
                null, listOf("kohima")
            )
        )
        ...
        questions.add(
            Question(
                2, QuestionType.Radio, "Which is the largest(area) state of India?",
        ...
        questions.add(
            Question(
                3, QuestionType.CheckBox, "Which of these are state capitals?",
    ...
    private fun evaluateQuiz() {
        ...
        Toast.makeText(this, "You scored ${score} out of ${questions.size}", Toast.LENGTH_SHORT)
            .show()
    }
